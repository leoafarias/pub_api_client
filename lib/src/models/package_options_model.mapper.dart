...
class PackageOptionsMapper extends ClassMapperBase<PackageOptions> {
  ...
  static const Field<PackageOptions, bool> _f$isDiscontinued =
      Field('isDiscontinued', _$isDiscontinued, opt: true, def: false);
  static bool _$isUnlisted(PackageOptions v) => v.isUnlisted;
  static const Field<PackageOptions, bool> _f$isUnlisted =
      Field('isUnlisted', _$isUnlisted, opt: true, def: false);
  static String? _$replacedBy(PackageOptions v) => v.replacedBy;
  static const Field<PackageOptions, String> _f$replacedBy =
      Field('replacedBy', _$replacedBy, opt: true);
...
mixin PackageOptionsMappable {
  String toJson() {
    return PackageOptionsMapper.ensureInitialized()
        .encodeJson<PackageOptions>(this as PackageOptions);
  }

  Map<String, dynamic> toMap() {
    return PackageOptionsMapper.ensureInitialized()
        .encodeMap<PackageOptions>(this as PackageOptions);
  }
  ...
  String toString() {
    return PackageOptionsMapper.ensureInitialized()
        .stringifyValue(this as PackageOptions);
  }
  ...
  int get hashCode {
    return PackageOptionsMapper.ensureInitialized()
        .hashValue(this as PackageOptions);
  }
}
...
extension PackageOptionsValueCopy<$R, $Out>
  ...
  PackageOptionsCopyWith<$R, PackageOptions, $Out> get $asPackageOptions =>
      $base.as((v, t, t2) => _PackageOptionsCopyWithImpl(v, t, t2));
}
...
class _PackageOptionsCopyWithImpl<$R, $Out>
  ...
  PackageOptionsCopyWith<$R2, PackageOptions, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
      _PackageOptionsCopyWithImpl($value, $cast, t);
}
