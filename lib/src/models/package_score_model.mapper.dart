...
class PackageScoreMapper extends ClassMapperBase<PackageScore> {
  ...
  static const Field<PackageScore, int> _f$grantedPoints = Field(
    'grantedPoints',
    _$grantedPoints,
  );
  static int? _$maxPoints(PackageScore v) => v.maxPoints;
  static const Field<PackageScore, int> _f$maxPoints = Field(
    'maxPoints',
    _$maxPoints,
  );
  static int _$likeCount(PackageScore v) => v.likeCount;
  static const Field<PackageScore, int> _f$likeCount = Field(
    'likeCount',
    _$likeCount,
  );
  static double? _$popularityScore(PackageScore v) => v.popularityScore;
  static const Field<PackageScore, double> _f$popularityScore = Field(
    'popularityScore',
    _$popularityScore,
  );
  static int? _$downloadCount30Days(PackageScore v) => v.downloadCount30Days;
  static const Field<PackageScore, int> _f$downloadCount30Days = Field(
    'downloadCount30Days',
    _$downloadCount30Days,
  );
  static List<String> _$tags(PackageScore v) => v.tags;
  static const Field<PackageScore, List<String>> _f$tags = Field(
    'tags',
    _$tags,
  );
...
mixin PackageScoreMappable {
  String toJson() {
    return PackageScoreMapper.ensureInitialized().encodeJson<PackageScore>(
      this as PackageScore,
    );
  }

  Map<String, dynamic> toMap() {
    return PackageScoreMapper.ensureInitialized().encodeMap<PackageScore>(
      this as PackageScore,
    );
  }

  PackageScoreCopyWith<PackageScore, PackageScore, PackageScore> get copyWith =>
      _PackageScoreCopyWithImpl<PackageScore, PackageScore>(
        this as PackageScore,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return PackageScoreMapper.ensureInitialized().stringifyValue(
      this as PackageScore,
    );
  }
  ...
  bool operator ==(Object other) {
    return PackageScoreMapper.ensureInitialized().equalsValue(
      this as PackageScore,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PackageScoreMapper.ensureInitialized().hashValue(
      this as PackageScore,
    );
  }
}
...
extension PackageScoreValueCopy<$R, $Out>
  ...
  PackageScoreCopyWith<$R, PackageScore, $Out> get $asPackageScore =>
      $base.as((v, t, t2) => _PackageScoreCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _PackageScoreCopyWithImpl<$R, $Out>
  ...
  PackageScore $make(CopyWithData data) => PackageScore(
    ...
    downloadCount30Days: data.get(
      #downloadCount30Days,
      or: $value.downloadCount30Days,
    ),
  ...
  PackageScoreCopyWith<$R2, PackageScore, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _PackageScoreCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
