...
/// @nodoc
abstract class _$$PackageOptionsImplCopyWith<$Res>
    implements $PackageOptionsCopyWith<$Res> {
  factory _$$PackageOptionsImplCopyWith(_$PackageOptionsImpl value,
          $Res Function(_$PackageOptionsImpl) then) =
      __$$PackageOptionsImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({bool isDiscontinued, bool isUnlisted, String? replacedBy});
}
...
/// @nodoc
class __$$PackageOptionsImplCopyWithImpl<$Res>
    extends _$PackageOptionsCopyWithImpl<$Res, _$PackageOptionsImpl>
    implements _$$PackageOptionsImplCopyWith<$Res> {
  __$$PackageOptionsImplCopyWithImpl(
      _$PackageOptionsImpl _value, $Res Function(_$PackageOptionsImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$PackageOptionsImpl(
      isDiscontinued: null == isDiscontinued
          ? _value.isDiscontinued
          : isDiscontinued // ignore: cast_nullable_to_non_nullable
              as bool,
...
/// @nodoc
@JsonSerializable()
class _$PackageOptionsImpl implements _PackageOptions {
  const _$PackageOptionsImpl(
      {required this.isDiscontinued,
      required this.isUnlisted,
      this.replacedBy});

  factory _$PackageOptionsImpl.fromJson(Map<String, dynamic> json) =>
      _$$PackageOptionsImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$PackageOptionsImplCopyWith<_$PackageOptionsImpl> get copyWith =>
      __$$PackageOptionsImplCopyWithImpl<_$PackageOptionsImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$PackageOptionsImplToJson(
      this,
    );
  }
}
...
abstract class _PackageOptions implements PackageOptions {
  const factory _PackageOptions(
      ...
      required final bool isUnlisted,
      final String? replacedBy}) = _$PackageOptionsImpl;

  factory _PackageOptions.fromJson(Map<String, dynamic> json) =
      _$PackageOptionsImpl.fromJson;
