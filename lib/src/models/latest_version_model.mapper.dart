...
class LatestVersionMapper extends ClassMapperBase<LatestVersion> {
  ...
  static const Field<LatestVersion, bool> _f$needUpdate = Field(
    'needUpdate',
    _$needUpdate,
  );
  static String _$latestVersion(LatestVersion v) => v.latestVersion;
  static const Field<LatestVersion, String> _f$latestVersion = Field(
    'latestVersion',
    _$latestVersion,
  );
  static PubPackage _$packageInfo(LatestVersion v) => v.packageInfo;
  static const Field<LatestVersion, PubPackage> _f$packageInfo = Field(
    'packageInfo',
    _$packageInfo,
  );
...
mixin LatestVersionMappable {
  String toJson() {
    return LatestVersionMapper.ensureInitialized().encodeJson<LatestVersion>(
      this as LatestVersion,
    );
  }

  Map<String, dynamic> toMap() {
    return LatestVersionMapper.ensureInitialized().encodeMap<LatestVersion>(
      this as LatestVersion,
    );
  }

  LatestVersionCopyWith<LatestVersion, LatestVersion, LatestVersion>
  get copyWith => _LatestVersionCopyWithImpl<LatestVersion, LatestVersion>(
    this as LatestVersion,
    $identity,
    $identity,
  );
  @override
  String toString() {
    return LatestVersionMapper.ensureInitialized().stringifyValue(
      this as LatestVersion,
    );
  }
  ...
  bool operator ==(Object other) {
    return LatestVersionMapper.ensureInitialized().equalsValue(
      this as LatestVersion,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return LatestVersionMapper.ensureInitialized().hashValue(
      this as LatestVersion,
    );
  }
}
...
extension LatestVersionValueCopy<$R, $Out>
  ...
  LatestVersionCopyWith<$R, LatestVersion, $Out> get $asLatestVersion =>
      $base.as((v, t, t2) => _LatestVersionCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _LatestVersionCopyWithImpl<$R, $Out>
  ...
  LatestVersionCopyWith<$R2, LatestVersion, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _LatestVersionCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
