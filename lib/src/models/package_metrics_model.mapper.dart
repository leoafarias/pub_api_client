...
class PackageMetricsMapper extends ClassMapperBase<PackageMetrics> {
  ...
  static const Field<PackageMetrics, PackageScore> _f$score =
      Field('score', _$score);
  static PackageScoreCard _$scorecard(PackageMetrics v) => v.scorecard;
  static const Field<PackageMetrics, PackageScoreCard> _f$scorecard =
      Field('scorecard', _$scorecard);
  ...
  static PackageMetrics _instantiate(DecodingData data) {
    return PackageMetrics(
        score: data.dec(_f$score), scorecard: data.dec(_f$scorecard));
  }
...
mixin PackageMetricsMappable {
  String toJson() {
    return PackageMetricsMapper.ensureInitialized()
        .encodeJson<PackageMetrics>(this as PackageMetrics);
  }

  Map<String, dynamic> toMap() {
    return PackageMetricsMapper.ensureInitialized()
        .encodeMap<PackageMetrics>(this as PackageMetrics);
  }

  PackageMetricsCopyWith<PackageMetrics, PackageMetrics, PackageMetrics>
      get copyWith => _PackageMetricsCopyWithImpl(
          this as PackageMetrics, $identity, $identity);
  @override
  String toString() {
    return PackageMetricsMapper.ensureInitialized()
        .stringifyValue(this as PackageMetrics);
  }
  ...
  int get hashCode {
    return PackageMetricsMapper.ensureInitialized()
        .hashValue(this as PackageMetrics);
  }
}
...
extension PackageMetricsValueCopy<$R, $Out>
  ...
  PackageMetricsCopyWith<$R, PackageMetrics, $Out> get $asPackageMetrics =>
      $base.as((v, t, t2) => _PackageMetricsCopyWithImpl(v, t, t2));
}
...
class _PackageMetricsCopyWithImpl<$R, $Out>
  ...
  PackageScoreCardCopyWith<$R, PackageScoreCard, PackageScoreCard>
      get scorecard =>
          $value.scorecard.copyWith.$chain((v) => call(scorecard: v));
  @override
  $R call({PackageScore? score, PackageScoreCard? scorecard}) =>
  ...
  PackageMetricsCopyWith<$R2, PackageMetrics, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
      _PackageMetricsCopyWithImpl($value, $cast, t);
}
